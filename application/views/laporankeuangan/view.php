            ...
            <div class="row">
              ...
              <div class="col-md-offset-8 col-md-2">
                ...
                <div class="box-footer">
                  <a href="<?php echo base_url('report/cetakbukubesar/'.$idtutupbuku) ?>" type="button" class="btn btn-primary" target="_blank"><i class="fa fa-print"> cetak pdf</i></a>
                </div>
              </div>
            </div>
          </div>
              ...
              <table id="tunda" class="table table-bordered table-hover dataTable">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><?php echo "Jurnal ".$idtutupbuku ?></td>
          ...
          <div class="box-status">
            <div class="row">
              <div class="col-md-offset-10 col-md-2">
                <label>Cetak Report</label>
                <div class="box-footer">
                  <a href="<?php echo base_url('report/cetakneracasaldo/'.$idtutupbuku) ?>" type="button" class="btn btn-primary" target="_blank"><i class="fa fa-print"> cetak pdf</i></a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="box-status">
            <div class="row">
              <div class="col-md-offset-10 col-md-2">
                <label>Cetak Report</label>
                <div class="box-footer">
                  <a href="<?php echo base_url('report/cetaklabarugi/'.$idtutupbuku) ?>" type="button" class="btn btn-primary" target="_blank"><i class="fa fa-print"> cetak pdf</i></a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="box-status">
            <div class="row">
              <div class="col-md-offset-10 col-md-2">
                <label>Cetak Report</label>
                <div class="box-footer">
                  <a href="<?php echo base_url('report/cetakneraca/'.$idtutupbuku) ?>" type="button" class="btn btn-primary" target="_blank"><i class="fa fa-print"> cetak pdf</i></a>
                </div>
              </div>
            </div>
          </div>
