...
<div class="row">
            ...
            <div class="box-body box-profile">
              ...
              <ul class="list-group list-group-unbordered">
                <li class="list-group-item">
                  <b>Tgl Buka Rekening</b> <a class="pull-right"><?php echo date("d/m/Y", strtotime($edit->tgl_bukarek))?></a>
                </li>
                <li class="list-group-item">
        ...
        <div class="col-md-9">
          <div class="box box-success">
            ...
            <?php echo form_open_multipart('bagtab/nasabah/update','class="form-horizontal"'); ?>
            <div class="box-body">
              <div class="row">
                <div class="col-sm-12">
                  ...
                  <div class="form-row">
                    <div class="col-sm-12">
                      <div class="form-group">
                        ...
                        <div class="col-md-4 col-sm-9">
                          <textarea class="form-control" name="alamat" rows="7" cols="50" placeholder="Masukkan alamat lengkap"><?php echo $edit->alamat;?></textarea>
                        </div>
