<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li class="active">Transaksi Penarikan Tabungan</li>
  </ol>
</section>
...
<div class="row">
  <div class="col-md-12">
   ...
   <div class="col-md-12">
     <div class="box box-success">
       ...
       <?php echo form_open_multipart('bagtab/penarikan/tambah','class="form-horizontal"'); ?>
       <div class="box-body">
         <div class="form-row">
           <div class="col-sm-12">
                 ...
                 <select name="id_rek" onchange="changeRek(this.value)" class="form-control select2" style="width: 100%">
                   ...
                   <?php foreach ($vResult as $row) {
                     ...
                     $jsRek .= "prdName['".$row['id_reknasabah']."'] ={
                       s_last:'".addslashes(number_format($row['saldo_akhir'],0,'.',','))."'};\n";
                   }?>
                 </select>
               </div>
             </div>
           ...
           <div class="col-sm-12">
             <div class="form-group">
               ...
               <div class="col-sm-10">
                 <div class="input-group">
                   <span class="input-group-addon">Rp.</span>
                   <input class="form-control rp" placeholder="Masukkan nominal pengambilan tunai" name="nominal" type="text" id="e_nominal">
                 </div>
                 <span style="color:red; font-size:12px;">* pastikan saldo akhir mencukupi dengan nominal lebih besar dari Rp.100.000,00</span>
               </div>
             </div>
           </div>
         </div>
           ...
           <div class="col-sm-12">
             <div class="form-group">
               ...
               <div class="col-sm-10">
                 <div class="input-group">
                   <span class="input-group-addon">Rp.</span>
                   <input class="form-control rp" placeholder="Sisa saldo setelah melakukan penarikan" type="text" id="e_sisa" readonly>
                 </div>
               </div>
             </div>
           </div>
  ...
  <div class="col-md-12">
    <div class="box box-success">
     <div class="box-header">
       <h3 class="box-title">View Transaksi Penarikan</h3>
     </div>
     <!-- /.box-header -->
     <div class="box-body">
         ...
         <table id="example23" class="table table-bordered table-hover dataTable">
           ...
           <tbody>
             ...
             <tr>
               ...
               <td style="text-align:right;"><?php echo number_format($i->debet,2,'.',','); ?></td>
...
<script type="text/javascript">
  ...
  function changeRek(id){
    document.getElementById('e_saldoakhir').value = prdName[id].s_last;
  };
