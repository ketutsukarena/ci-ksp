...
<head>
    ...
    <title>Home| SMA Negeri 1 Raha</title>
	<!-- core CSS -->
...
<body id="home" class="homepage">
        ...
        <nav id="main-menu" class="navbar navbar-default navbar-fixed-top" role="banner">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.html"><img src="<?php echo base_url('assets/img/logo-kop.png') ?>" alt="logo"></a>
                </div>
    ...
    <script src="<?php echo base_url('assets/front/js/mousescroll.js')?>"></script>
