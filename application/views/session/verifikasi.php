...
<div class="login-box">
  ...
  <div class="login-box-body">
    ...
    <p class="login-box-msg">Kode Verifikasi Dari Email</p>
    ...
    <?php echo validation_errors();
      ...
      <?php } ?>
    <?php echo form_open('auth/verifikasi'); ?>
      <div class="form-group has-feedback">
        <input type="text" class="form-control" placeholder="Masukkan kode verifikasi" name="kode" required>
